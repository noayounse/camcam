class BoundingBox {
  ...
  ArrayList<PVector> makePaddedAdjustedBoundingBox(PVector normalIn, ArrayList<PVector> pointsIn, float topAddition, float rightAddition, float bottomAddition, float leftAddition, float frontAddition, float rearAddition) {
  ...
  ArrayList<PVector> makePaddedAdjustedBoundingBoxForAspect(PVector normalIn, ArrayList<PVector> pointsIn, float topAddition, float rightAddition, float bottomAddition, float leftAddition, float frontAddition, float rearAddition, float aspectIn) {
  ...
  void drawBox(ArrayList<PVector> pointsIn) {
    if (pointsIn.size() > 0) {
      noFill();
      beginShape();

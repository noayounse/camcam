...
void keyReleased() {
  ...
  if (key == 'p') simpleCam.setPosition(new PVector(40, -100, 300), new PVector(40, -99, 50), 420);
  if (key == 'o') simpleCam.setPosition(new PVector(100, -1, 400), new PVector(100, 0, 0), 420);
